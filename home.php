...
<body id="page-top" class="index">
  <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom" style="background-color: black;">
    <div class="container ">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <ul class="nav navbar-nav navbar-right">
      ...
      if($status == '0'){
        ...
        <li>
           <a href="#" > <i class="fa fa-user nav-icon" aria-hidden="true"></i> your account </a>
        </li>
                '
        ;
      }
      ...
      <div class="modal-body">
        <form method="post" action="Register.php">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control form-input" name="email" id="emails" placeholder="E-Mail" maxlength="40" required/>
          </div>
          <div class="form-group">
            <label for="pswd" class="ui-hidden-accessible">Password</label>
  ...
  <div class="footer-above">
    ...
    <div class="footer-below">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
           <p class="small">Developed By </p><h4 style="color: #00b3fe">SUMIT</h4> 
         </div>
       </div>
     </div>
   </div>
